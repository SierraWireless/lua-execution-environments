------------------------------------------------------------------------------
-- @field[parent = #global] Stage#Stage stage 

------------------------------------------------------------------------------
-- @field[parent = #global] Application#Application application 

------------------------------------------------------------------------------
-- @field[parent = #global] Geolocation#Geolocation geolocation 

------------------------------------------------------------------------------
-- @field[parent = #global] Gyroscope#Gyroscope gyroscope 

------------------------------------------------------------------------------
-- @field[parent = #global] Event#Event Event 

------------------------------------------------------------------------------
-- @field[parent = #global] Accelerometer#Accelerometer accelerometer 

------------------------------------------------------------------------------
-- @field[parent = #global] Font#Font Font 

------------------------------------------------------------------------------
-- @field[parent = #global] TTFont#TTFont TTFont 

------------------------------------------------------------------------------
-- @field[parent = #global] MovieClip#MovieClip MovieClip 

------------------------------------------------------------------------------
-- @field[parent = #global] TileMap#TileMap TileMap 

------------------------------------------------------------------------------
-- @field[parent = #global] TextField#TextField TextField 

------------------------------------------------------------------------------
-- @field[parent = #global] Bitmap#Bitmap Bitmap 

------------------------------------------------------------------------------
-- @field[parent = #global] Timer#Timer Timer 

------------------------------------------------------------------------------
-- @field[parent = #global] Shape#Shape Shape 

------------------------------------------------------------------------------
-- @field[parent = #global] Sound#Sound Sound 
