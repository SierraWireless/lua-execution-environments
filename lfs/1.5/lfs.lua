...
--
function attributes(filepath , aname) end
...
-- @return #nil, #string In error cases, error string is provided.
--
function lock_dir(path, seconds_stale) end
...
-- @return #nil, #string In error cases, error string is provided.
--
function lock(filehandle, mode, start, length) end
...
--
function setmode(file, mode) end
...
--
function symlinkattributes(filepath , aname) end
...
-- @return #nil, #string In error cases, error string is provided.
--
function touch(filepath , atime , mtime) end
...
-- @return #nil, #string In error cases, error string is provided.
--
function unlock(filehandle, start, length) end
